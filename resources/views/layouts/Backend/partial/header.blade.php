...
>
  <head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('admin-backend/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('index') }}" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img class="img-fluid" src="{{URL::asset('admin-backend/assets/img/icons') }}/{{ getSiteSetting() !== null ? getSiteSetting()->logo : ''  }}" alt="" style="width:50px;">
              ...
              <span class="app-brand-text fs-3 menu-text fw-bolder ms-2">{{ getSiteSetting() !== null ? getSiteSetting()->name : '' }}</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ route('viewForm') }}" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">View Form</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('viewListing') }}" class="menu-link">
                    <div data-i18n="Text Divider">View Listing</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ URL::asset('admin-backend/assets/img/avatars/1.png') }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
